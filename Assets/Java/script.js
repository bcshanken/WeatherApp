    ...
    function forcastData(){
      ...
      $.ajax({
          ...
          method: "GET",
            ...
            // forcast temp
          $("#dayOneTemp").text("Temp: " + Math.floor(responseTwo.list[0].main.temp_max) + " F");
          $("#dayTwoTemp").text("Temp: " + Math.floor(responseTwo.list[8].main.temp_max) + " F");
          $("#dayThreeTemp").text("Temp: " + Math.floor(responseTwo.list[16].main.temp_max) + " F");
          $("#dayFourTemp").text("Temp: " + Math.floor(responseTwo.list[24].main.temp_max) + " F");
          $("#dayFiveTemp").text("Temp: " + Math.floor(responseTwo.list[32].main.temp_max) + " F");
            // forcast humidity
            $("#dayOneHumidity").text("Humidity: " + Math.floor(responseTwo.list[0].main.humidity) + " %");
          $("#dayTwoHumidity").text("Humidity: " + Math.floor(responseTwo.list[8].main.humidity) + " %");
          $("#dayThreeHumidity").text("Humidity: " + Math.floor(responseTwo.list[16].main.humidity) + " %");
          $("#dayFourHumidity").text("Humidity: " + Math.floor(responseTwo.list[24].main.humidity) + " %");
          $("#dayFiveHumidity").text("Humidity: " + Math.floor(responseTwo.list[32].main.humidity) + " %");
      })
    }
